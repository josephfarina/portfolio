...
/***/ function(module, exports, __webpack_require__) {
	...
	var app_component_1 = __webpack_require__(669);
	var http_1 = __webpack_require__(287);
	var app_routes_1 = __webpack_require__(687);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var router_1 = __webpack_require__(29);
	var nav_component_1 = __webpack_require__(671);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var router_1 = __webpack_require__(29);
	var nav_title_service_1 = __webpack_require__(336);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var DrumMachineInstrumentBeatDirective = (function () {
	    function DrumMachineInstrumentBeatDirective(_el) {
	        this._el = _el;
	        this.color = { 'active': '#39B54A', 'inactive': '#003B05' };
	        this.checkIfSnapInit = false;
	        this.el = _el.nativeElement;
	    }
	    DrumMachineInstrumentBeatDirective.prototype.ngOnChanges = function (changes) {
	    ...
	    DrumMachineInstrumentBeatDirective.prototype.ngAfterViewInit = function () {
	        this.s = Snap(this.el);
	        this.checkIfSnapInit = true;
	        this.check();
	    };
	    DrumMachineInstrumentBeatDirective.prototype.check = function () {
	    ...
	    ], DrumMachineInstrumentBeatDirective.prototype, "beat", void 0);
	    __decorate([
	        core_1.Input('current-beat'), 
	        __metadata('design:type', Number)
	    ], DrumMachineInstrumentBeatDirective.prototype, "currentBeat", void 0);
	    DrumMachineInstrumentBeatDirective = __decorate([
	        core_1.Directive({
	            selector: '[my-instrument-beat-changer]'
	        }), 
	        __metadata('design:paramtypes', [core_1.ElementRef])
	    ], DrumMachineInstrumentBeatDirective);
	    return DrumMachineInstrumentBeatDirective;
	}());
	exports.DrumMachineInstrumentBeatDirective = DrumMachineInstrumentBeatDirective;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var DrumMachineButtonDirective = (function () {
	    function DrumMachineButtonDirective(_el) {
	        this._el = _el;
	    ...
	    DrumMachineButtonDirective.prototype.ngOnChanges = function (changes) {
	        // FIXME: this is a hacky way of making sure that Snap has been initiated -- It cant be called before snap is created
	        if (this.checkIfSnapInit) {
	            this.check();
	        }
	    ...
	    DrumMachineButtonDirective.prototype.ngAfterViewInit = function () {
	        var _this = this;
	        this.s = Snap(this.el);
	    ...
	    DrumMachineButtonDirective.prototype.init = function () {
	        if (this.isActivated) {
	    ...
	    DrumMachineButtonDirective.prototype.check = function () {
	        if (this.isActivated) {
	            this.s.animate({ transform: 't0, -3.5' }, 200, mina.elastic);
	            this.activeIndicator.animate({ fill: '#FF4856' }, 200, mina.easeinout);
	        }
	    ...
	    DrumMachineButtonDirective.prototype.valueOut = function () {
	        this.value.emit({
	    ...
	    ], DrumMachineButtonDirective.prototype, "value", void 0);
	    __decorate([
	        core_1.Input('initial'), 
	        __metadata('design:type', Boolean)
	    ], DrumMachineButtonDirective.prototype, "isActivated", void 0);
	    DrumMachineButtonDirective = __decorate([
	        core_1.Directive({ selector: '[my-button-pusher]' }), 
	        __metadata('design:paramtypes', [core_1.ElementRef])
	    ], DrumMachineButtonDirective);
	    return DrumMachineButtonDirective;
	}());
	exports.DrumMachineButtonDirective = DrumMachineButtonDirective;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var DrumMachineInstrumentButtonDirective = (function () {
	    function DrumMachineInstrumentButtonDirective(_el) {
	        this._el = _el;
	        this.value = new core_1.EventEmitter();
	    ...
	    DrumMachineInstrumentButtonDirective.prototype.ngOnChanges = function (changes) {
	        // FIXME: this is a hacky way of making sure that Snap has been initiated -- It cant be called before snap is created
	        if (this.checkIfSnapInit) {
	            this.check();
	        }
	    ...
	    DrumMachineInstrumentButtonDirective.prototype.ngAfterViewInit = function () {
	        var _this = this;
	        this.s = Snap(this.el);
	        ...
	        this.s.hover(function (e) {
	            if (_this.instrument !== _this.currentInstrument) {
	                _this.background.animate({
	                    fill: _this.colors['background-hover']
	                }, 100, mina.easein);
	                _this.s.animate({
	    ...
	    DrumMachineInstrumentButtonDirective.prototype.check = function () {
	        var _this = this;
	        if (this.instrument === this.currentInstrument) {
	            ...
	            this.text.forEach(function (elem) {
	                elem.animate({
	                    fill: _this.colors['light-active']
	                }, 100, mina.easein);
	            });
	        }
	        else {
	    ...
	    DrumMachineInstrumentButtonDirective.prototype.valueOut = function () {
	    ...
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DrumMachineInstrumentButtonDirective.prototype, "value", void 0);
	    __decorate([
	        core_1.Input('type'), 
	        __metadata('design:type', String)
	    ], DrumMachineInstrumentButtonDirective.prototype, "instrument", void 0);
	    __decorate([
	        core_1.Input('current'), 
	        __metadata('design:type', String)
	    ], DrumMachineInstrumentButtonDirective.prototype, "currentInstrument", void 0);
	    __decorate([
	        core_1.Input('button-group'), 
	        __metadata('design:type', String)
	    ], DrumMachineInstrumentButtonDirective.prototype, "buttonGroup", void 0);
	    __decorate([
	        core_1.Input('kit'), 
	        __metadata('design:type', String)
	    ], DrumMachineInstrumentButtonDirective.prototype, "kit", void 0);
	    __decorate([
	        core_1.Input('current-kit'), 
	        __metadata('design:type', String)
	    ], DrumMachineInstrumentButtonDirective.prototype, "currentKit", void 0);
	    DrumMachineInstrumentButtonDirective = __decorate([
	        core_1.Directive({ selector: '[my-instrument-button-pusher]' }), 
	        __metadata('design:paramtypes', [core_1.ElementRef])
	    ], DrumMachineInstrumentButtonDirective);
	    return DrumMachineInstrumentButtonDirective;
	}());
	exports.DrumMachineInstrumentButtonDirective = DrumMachineInstrumentButtonDirective;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var DrumMachineKitButtonDirective = (function () {
	    function DrumMachineKitButtonDirective(_el) {
	        this._el = _el;
	        this.value = new core_1.EventEmitter();
	        this.kit = 'default';
	        this.colors = { 'active': '#39B54A', 'inactive': '#003B05', 'light-active': 'white',
	            'light-inactive': 'black', 'background-hover': 'lightgray' };
	        this.checkIfSnapInit = false;
	        this.el = _el.nativeElement;
	    }
	    DrumMachineKitButtonDirective.prototype.ngOnChanges = function (changes) {
	        // FIXME: this is a hacky way of making sure that Snap has been initiated -- It cant be called before snap is created
	        if (this.checkIfSnapInit) {
	            this.check();
	        }
	    ...
	    DrumMachineKitButtonDirective.prototype.ngAfterViewInit = function () {
	        var _this = this;
	        this.s = Snap(this.el);
	        this.background = this.s.select('rect');
	        this.activeIndicator = this.s.select('circle');
	        ...
	        this.s.mouseout(function (e) {
	            if (_this.kit !== _this.currentKit) {
	                _this.background.animate({ fill: _this.colors['background'],
	    ...
	    DrumMachineKitButtonDirective.prototype.check = function () {
	        var _this = this;
	        if (this.kit === this.currentKit) {
	            this.s.animate({ transform: 't0,1.2, s.98, .97' }, 100, mina.elastic);
	            this.activeIndicator.animate({
	                fill: this.colors['active'] }, 100, mina.easein);
	            this.text.forEach(function (elem) {
	                elem.animate({
	                    fill: _this.colors['light-active'] }, 100, mina.easein);
	            });
	        }
	        else {
	            this.activeIndicator.attr({ fill: this.colors['inactive'] });
	    ...
	    DrumMachineKitButtonDirective.prototype.valueOut = function () {
	        this.value.emit({
	            value: this.kit
	        });
	    };
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DrumMachineKitButtonDirective.prototype, "value", void 0);
	    __decorate([
	        core_1.Input('kit'), 
	        __metadata('design:type', String)
	    ], DrumMachineKitButtonDirective.prototype, "kit", void 0);
	    __decorate([
	        core_1.Input('current-kit'), 
	        __metadata('design:type', String)
	    ], DrumMachineKitButtonDirective.prototype, "currentKit", void 0);
	    DrumMachineKitButtonDirective = __decorate([
	        core_1.Directive({
	            selector: '[my-kit-button-pusher]'
	        }), 
	        __metadata('design:paramtypes', [core_1.ElementRef])
	    ], DrumMachineKitButtonDirective);
	    return DrumMachineKitButtonDirective;
	}());
	exports.DrumMachineKitButtonDirective = DrumMachineKitButtonDirective;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var DrumMachineKnobDirective = (function () {
	    function DrumMachineKnobDirective(_el) {
	        this._el = _el;
	        this.value = new core_1.EventEmitter();
	        this.angle = 0;
	        this.minAngle = -130;
	    ...
	    DrumMachineKnobDirective.prototype.onMouse = function (e) {
	        e.preventDefault();
	        this.rotate(e.deltaY);
	    };
	    DrumMachineKnobDirective.prototype.ngAfterViewInit = function () {
	        var _this = this;
	        this.s = Snap(this.el);
	    ...
	    DrumMachineKnobDirective.prototype.calculateValue = function () {
	    ...
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DrumMachineKnobDirective.prototype, "value", void 0);
	    __decorate([
	        core_1.Input('starting'), 
	        __metadata('design:type', Number)
	    ], DrumMachineKnobDirective.prototype, "startingAngle", void 0);
	    __decorate([
	...
	exports.DrumMachineKnobDirective = DrumMachineKnobDirective;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var DrumMachineStartButtonDirective = (function () {
	    function DrumMachineStartButtonDirective(_el) {
	        this._el = _el;
	        this.value = new core_1.EventEmitter();
	        this.start = false;
	        this.checkIfSnapInit = false;
	    ...
	    DrumMachineStartButtonDirective.prototype.ngOnChanges = function (changes) {
	        // FIXME: this is a hacky way of making sure that Snap has been initiated -- It cant be called before snap is created
	        if (this.checkIfSnapInit) {
	            this.check();
	        }
	    ...
	    DrumMachineStartButtonDirective.prototype.ngAfterViewInit = function () {
	        var _this = this;
	        this.s = Snap(this.el);
	    ...
	    DrumMachineStartButtonDirective.prototype.check = function () {
	        var _this = this;
	        if (this.start === true) {
	    ...
	    DrumMachineStartButtonDirective.prototype.valueOut = function () {
	        this.value.emit({
	            value: this.start
	        });
	    };
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DrumMachineStartButtonDirective.prototype, "value", void 0);
	    DrumMachineStartButtonDirective = __decorate([
	        core_1.Directive({
	            selector: '[my-start-button-pusher]'
	        }), 
	        __metadata('design:paramtypes', [core_1.ElementRef])
	    ], DrumMachineStartButtonDirective);
	    return DrumMachineStartButtonDirective;
	}());
	exports.DrumMachineStartButtonDirective = DrumMachineStartButtonDirective;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DrumMachineMetronomeService = (function () {
	    ...
	    DrumMachineMetronomeService.prototype.loadAudioSamples = function () {
	        var _this = this;
	        this.loadDrumKit();
	        var urlBody = 'samples/impulse/';
	        var impulse = new XMLHttpRequest();
	        impulse.open('GET', urlBody + 'church_impulse.wav', true);
	        impulse.responseType = 'arraybuffer';
	        impulse.onload = function () {
	            ;
	            _this.context.decodeAudioData(impulse.response).then(function (decodedData) {
	                _this.impulse = decodedData;
	            }, function (e) { console.log('Error with reverb audio data' + e.err); });
	        };
	        impulse.send();
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var drum_machine_metronome_service_1 = __webpack_require__(680);
	var SEQUENCER_LINEUP_1 = __webpack_require__(673);
	var drum_machine_knob_directive_1 = __webpack_require__(678);
	var drum_machine_button_directive_1 = __webpack_require__(675);
	var drum_machine_instrumentbutton_directive_1 = __webpack_require__(676);
	var drum_machine_beat_directive_1 = __webpack_require__(674);
	var drum_machine_startbutton_directive_1 = __webpack_require__(679);
	var drum_machine_kit_directive_1 = __webpack_require__(677);
	var DrumMachineComponent = (function () {
	    ...
	    DrumMachineComponent.prototype.instrumentKnob = function (event, instrument, knob) {
	    ...
	    DrumMachineComponent.prototype.beatOutputValue = function (event, beatNum) {
	    ...
	    DrumMachineComponent = __decorate([
	        core_1.Component({
	            directives: [
	                drum_machine_knob_directive_1.DrumMachineKnobDirective,
	                drum_machine_button_directive_1.DrumMachineButtonDirective,
	                drum_machine_instrumentbutton_directive_1.DrumMachineInstrumentButtonDirective,
	                drum_machine_beat_directive_1.DrumMachineInstrumentBeatDirective,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameInformationComponent = (function () {
	    ...
	    GameInformationComponent.prototype.ngOnInit = function () {
	    ...
	    GameInformationComponent.prototype.toggleTile = function () {
	        console.log('toggle');
	        this.ticTacToeService.toggleTile();
	        this.updateUserOne(true);
	        this.updateUserTwo(true);
	    };
	    GameInformationComponent.prototype.updateUserOne = function (withoutSetting) {
	    ...
	    GameInformationComponent.prototype.updateUserTwo = function (withoutSetting) {
	        if (withoutSetting == null) {
	            console.log('without');
	    ...
	    GameInformationComponent.prototype.gameStart = function () {
	        this.ticTacToeService.setUserOne(this.userOneName, this.userOneTileType);
	        this.ticTacToeService.setUserTwo(this.userTwoName, this.userTwoTileType);
	    ...
	    GameInformationComponent = __decorate([
	        core_1.Component({
	            moduleId: module.id,
	...
	exports.GameInformationComponent = GameInformationComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(29);
	var tictactoe_service_1 = __webpack_require__(136);
	var tiletype_directive_1 = __webpack_require__(682);
	var GamePlayComponent = (function () {
	    ...
	    GamePlayComponent.prototype.setPlayer = function () {
	    ...
	    GamePlayComponent.prototype.setTile = function (xaxis, yaxis) {
	    ...
	    GamePlayComponent.prototype.resetTileBoard = function () {
	        this.tileSetCount = 0;
	    ...
	    GamePlayComponent.prototype.checkForWinner = function (x, y) {
	    ...
	    GamePlayComponent.prototype.checkHorizontalWin = function (y) {
	        var count = 0;
	    ...
	    GamePlayComponent.prototype.checkVerticalWin = function (x) {
	        var count = 0;
	    ...
	    GamePlayComponent.prototype.checkDiagonalWin = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameResolutionComponent = (function () {
	    ...
	    GameResolutionComponent.prototype.ngOnInit = function () {
	        this.winner = this.ticTacToeService.getWinner();
	        if (this.winner === null) {
	            this.isTie = true;
	        }
	    };
	    GameResolutionComponent.prototype.playAgain = function () {
	        this.router.navigate(['/tictactoe', '/play']);
	    };
	    GameResolutionComponent.prototype.newGame = function () {
	        this.ticTacToeService.resetGame();
	        this.router.navigate(['/tictactoe', '/new']);
	    };
	    GameResolutionComponent = __decorate([
	        core_1.Component({
	            moduleId: module.id,
	        ...
	        __metadata('design:paramtypes', [tictactoe_service_1.TicTacToeService, router_1.Router])
	    ], GameResolutionComponent);
	    return GameResolutionComponent;
	}());
	exports.GameResolutionComponent = GameResolutionComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var tictactoe_component_1 = __webpack_require__(335);
	var game_play_component_1 = __webpack_require__(684);
	var game_information_component_1 = __webpack_require__(683);
	var game_resolution_component_1 = __webpack_require__(685);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var router_1 = __webpack_require__(29);
	var tictactoe_routes_1 = __webpack_require__(686);
	var home_component_1 = __webpack_require__(670);
	var calculator_component_1 = __webpack_require__(672);
	var tictactoe_component_1 = __webpack_require__(335);
	var drum_machine_component_1 = __webpack_require__(681);
	exports.routes = [
	    {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./calculator.component.style.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./calculator.component.style.scss");
